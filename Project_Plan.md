...
- Initially static translations, expandable to dynamic via Supabase

**Translation Responsibility:** ✅ All Hungarian and English translations will be generated by AI (Cursor) based on the Romanian content.
...
### 5.3 Content Management System (Supabase)
**Note:** For now, all content will be **mock/placeholder data** until the project is approved. Supabase admin panel setup will be discussed later.

**Content Types to Manage (Future):**
1. **Articles/News** - Title, content, date, category, images, translations
2. **Announcements** - Short notices with expiry dates
3. **Events** - Date, time, location, description
4. **Documents** - PDF uploads with metadata
5. **Financial Documents** - Budget, reports, audits
6. **Council Decisions** - HCL numbers, dates, PDFs
7. **Mayor's Dispositions** - Disposition numbers, dates, PDFs
8. **Public Debates** - Draft acts, comments, results
9. **Jobs/Competitions** - Positions, requirements, deadlines
10. **Gallery Images** - Categorized photo albums
