...
export default function RegistruAgricolPage() {
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center py-12">
                ...
                <p className="text-gray-600 max-w-md">
                  Această pagină este în curs de dezvoltare. În curând veți găsi informații despre registrul agricol, adeverințe și documente necesare.
                </p>
              </div>
            </CardContent>
          </Card>
