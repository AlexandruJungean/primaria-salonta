...
export default async function OferteTerenPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const oferteTerenDocs = await documents.getDocumentsByCategory('oferte_terenuri');
  ...
  return (
    <>
        ...
        <Container>
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-8">
              ...
              {oferteTerenDocs.length > 0 ? (
                <div className="space-y-3">
                  {oferteTerenDocs.map((doc) => (
      ...
      <AdminEditButton href="/admin/informatii-publice/oferte-terenuri" />
    </>
  );
}
