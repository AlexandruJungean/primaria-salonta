...
export default function DeclaratiiPrimariePage() {
  ...
  return (
    <div>
      ...
      <AdminTable data={declarations} columns={columns} loading={loading} onEdit={handleEdit} onDelete={confirmDelete} emptyMessage="Nu există declarații pentru anul selectat." />
